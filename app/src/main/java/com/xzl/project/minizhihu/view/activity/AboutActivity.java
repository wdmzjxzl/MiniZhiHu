...
import com.xzl.project.minizhihu.listener.AbstractSimpleActivity;
import com.xzl.project.minizhihu.utils.StatusBarUtil;
import com.xzl.project.minizhihu.widget.ElasticOutInterpolator;
...
public class AboutActivity extends AbstractSimpleActivity{
    ...
    protected void initEventAndData() {
        ...
        //监听 appbarlayout 的关闭和开启 给FlyView 和ActionButton设置关闭隐藏动画
